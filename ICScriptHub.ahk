...
Gui, ICScriptHub:Add, Text, x%g_LeftAlign% y+2 w%g_wColLeft% Right, Failed Stacking:
Gui, ICScriptHub:Add, Text, vFailedStackingID x+2 w50,

Gui, ICScriptHub:Add, Text, x%g_LeftAlign% y+10 w%g_wColLeft% Right, Silvers Gained:
Gui, ICScriptHub:Add, Text, vSilversPurchasedID x+2 w200, 0
Gui, ICScriptHub:Add, Text, x%g_LeftAlign% y+2 w%g_wColLeft% Right, Silvers Opened:
Gui, ICScriptHub:Add, Text, vSilversOpenedID x+2 w200, 0
Gui, ICScriptHub:Add, Text, x%g_LeftAlign% y+2 w%g_wColLeft% Right, Golds Gained:
Gui, ICScriptHub:Add, Text, vGoldsPurchasedID x+2 w200, 0
Gui, ICScriptHub:Add, Text, x%g_LeftAlign% y+2 w%g_wColLeft% Right, Golds Opened:
Gui, ICScriptHub:Add, Text, vGoldsOpenedID x+2 w200, 0
Gui, ICScriptHub:Add, Text, x%g_LeftAlign% y+2 w%g_wColLeft% Right, Shinies Found:
Gui, ICScriptHub:Add, Text, vShiniesID x+2 w200, 0

Gui, ICScriptHub:Font, cBlue w700
Gui, ICScriptHub:Add, Text, x%g_LeftAlign% y+10 w%g_wColLeft% Right, Bosses per hour:
Gui, ICScriptHub:Add, Text, vbossesPhrID x+2 w50, % bossesPhr

Gui, ICScriptHub:Font, cGreen
Gui, ICScriptHub:Add, Text, x%g_LeftAlign% y+10 w%g_wColLeft% Right, Total Gems:
Gui, ICScriptHub:Add, Text, vGemsTotalID x+2 w50, % GemsTotal
Gui, ICScriptHub:Add, Text, x%g_LeftAlign% y+2 w%g_wColLeft% Right, Gems per hour:
