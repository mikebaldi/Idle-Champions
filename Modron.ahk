...
global gBrivStacked	:= 0	;check for Briv stacked for when current level and sb stacks don't reset together and script falls back into stack farming loop
...
{  
	...
	loop 
	{
		...
		if (gLoopBosses > gprevBosses)
		{
        	...
        	if (Not gBrivStacked And gLevel_Number > AreaLow And gSBStacks < gSBStacksMax) 
		{
			FarmBrivStacks()
			Sleep 250
			gBrivStacked := 1
