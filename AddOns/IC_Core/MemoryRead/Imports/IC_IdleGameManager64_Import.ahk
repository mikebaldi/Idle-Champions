...
this.game.gameInstances.ActiveCampaignData.currentRules.MonsterDamageModifier := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentRules,"Double", [0x3a0])
