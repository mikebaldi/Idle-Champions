class IC_BrivGemFarm_AdvancedSettings_Component
{
    ...
    SaveAdvancedSettings() {
        ...
        g_BrivUserSettings[ "PostStackDashWaitOnly"] := OptionSettingCheck_PostStackDashWaitOnly
    ...
    AddToolTips() {
            ...
            GUIFunctions.AddToolTip( "OptionSettingCheck_PostStackDashWaitOnly", "Set if you only want dash wait to happen post stack.")
