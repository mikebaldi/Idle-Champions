...
class ReadMemoryFunctionsExtended
{
    ...
    Keep()
    {
        GuiControl, ICScriptHub:, ReadSecondsSinceLastSaveID, % g_SF.Memory.GenericGetValue(g_SF.Memory.GameManager.game.gameInstances.instanceLoadTimeSinceLastSave)
    }
}