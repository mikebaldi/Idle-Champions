...
this.game.gameInstances.Controller.userData := New GameObjectStructure(this.game.gameInstances.Controller,"Int", [0x50])
this.game.gameInstances.Controller.userData.ActiveUserGameInstance := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x164])
...
this.game.gameInstances.Controller.userData.BuffHandler.inventoryBuffs.inventoryAmount := New GameObjectStructure(this.game.gameInstances.Controller.userData.BuffHandler.inventoryBuffs,"Int", [0x80])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.def.SeatID := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.def,"Int", [0xf8])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByKeyName := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects,"List", [0x2c])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByKeyName.parentEffectKeyHandler := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByKeyName,"Int", [0x8])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByKeyName.parentEffectKeyHandler.activeEffectHandlers := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByKeyName.parentEffectKeyHandler,"List", [0x94])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"List", [0x10c])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered.ID := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered,"Int", [0x8])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered.SpecializationName := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered,"UTF-16", [0x20])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered.RequiredLevel := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered,"Int", [0x4c])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered.RequiredUpgradeID := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered,"Int", [0x54])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered.SpecializationGraphic := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered,"Int", [0x58])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.<Level>k__BackingField := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Int", [0x1ac])
...
this.game.gameInstances.Controller.area.secondsSinceStarted := New GameObjectStructure(this.game.gameInstances.Controller.area,"", [0x114])
this.TimeScale := New GameObjectStructure(this.GameManager,"", [0x48])
this.game.gameInstances.Controller.areaTransitioner := New GameObjectStructure(this.game.gameInstances.Controller,"Int", [0x20])
this.game.gameInstances.Controller.areaTransitioner.<IsTransitioning>k__BackingField := New GameObjectStructure(this.game.gameInstances.Controller.areaTransitioner,"Char", [0x1c])
...
this.game.gameInstances.PatronHandler.<ActivePatron>k__BackingField := New GameObjectStructure(this.game.gameInstances.PatronHandler,"Int", [0x10])
this.game.gameInstances.PatronHandler.<ActivePatron>k__BackingField.ID := New GameObjectStructure(this.game.gameInstances.PatronHandler.<ActivePatron>k__BackingField,"Int", [0x8])
this.game.gameInstances.PatronHandler.<ActivePatron>k__BackingField.Tier := New GameObjectStructure(this.game.gameInstances.PatronHandler.<ActivePatron>k__BackingField,"Int", [0x70])
...
this.game.screenController.activeScreen.currentScreenWidth := New GameObjectStructure(this.game.screenController.activeScreen,"Int", [0x23c])
this.game.screenController.activeScreen.currentScreenHeight := New GameObjectStructure(this.game.screenController.activeScreen,"Int", [0x240])
...
this.game.gameInstances.Controller.userData.inited := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Char", [0x150])
this.game.gameInstances.Controller.userData.redRubies := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x134])
this.game.gameInstances.Controller.userData.redRubiesSpent := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x138])
...
this.game.gameInstances.Controller.formation.slots.heroAlive := New GameObjectStructure(this.game.gameInstances.Controller.formation.slots,"Char", [0x151])
this.game.gameInstances.Controller.formation.TransitionOverrides := New GameObjectStructure(this.game.gameInstances.Controller.formation,"List", [0x54])
...
this.game.gameInstances.Screen.uiController := New GameObjectStructure(this.game.gameInstances.Screen,"Int", [0x270])
...
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar,"Int", [0x23c])
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox,"Int", [0x258])
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButton := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar,"Int", [0x240])
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButton.toggled := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButton,"Char", [0x27a])
...
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar,"Int", [0x24c])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel,"List", [0x26c])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.nextUpgrade := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes,"Int", [0x290])
...
this.game.gameInstances.Screen.uiController.ultimatesBar.ultimateItems := New GameObjectStructure(this.game.gameInstances.Screen.uiController.ultimatesBar,"List", [0x260])
this.game.gameInstances.Screen.uiController.ultimatesBar.ultimateItems.hero := New GameObjectStructure(this.game.gameInstances.Screen.uiController.ultimatesBar.ultimateItems,"Int", [0x258])
