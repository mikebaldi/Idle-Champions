...
class IC_GameManagerEGS_Class
{
    ...
    GetVersion()
    {
        return "v1.9.14, 2022-03-26, IC v0.422.4+, EGS"
    }
    ...
    Refresh()
    {
        ...
        this.Game.GameInstance.Controller.UserData.ModronHandler.ModronSavesList.ExpTotal := New GameObjectStructure(this.Game.GameInstance.Controller.UserData.ModronHandler.ModronSavesList, "Float", [0x50])  
        ...
        this.Game.GameInstance.Screen.uiController.ultimatesBar.ultimateItemsList := New GameObjectStructure(this.Game.GameInstance.Screen.uiController.ultimatesBar, "List", [0x388, 0x10]) ; Push ultimatesItems._items
        this.Game.GameInstance.Screen.uiController.ultimatesBar.ultimateItemsListSize := New GameObjectStructure(this.Game.GameInstance.Screen.uiController.ultimatesBar,, [0x388, 0x18]) ; Push ultimatesItems._size
        this.Game.GameInstance.Screen.uiController.ultimatesBar.ultimateItemsList.hero := New GameObjectStructure(this.Game.GameInstance.Screen.uiController.ultimatesBar.ultimateItemsList,, [0x378])
