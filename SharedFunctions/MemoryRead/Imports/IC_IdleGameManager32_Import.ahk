...
this.game.gameInstances.Controller.userData := New GameObjectStructure(this.game.gameInstances.Controller,"Int", [0x58])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Int", [0x44])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Dict", [0x15c])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.Benched := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Char", [0x198])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.level := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Int", [0x1b4])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.purchasedUpgradeIDs := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"HashSet", [0x160])
...
this.game.gameInstances.Controller.area.basicMonstersSpawnedThisArea := New GameObjectStructure(this.game.gameInstances.Controller.area,"Int", [0x158])
...
this.game.gameInstances.Controller.area.secondsSinceStarted := New GameObjectStructure(this.game.gameInstances.Controller.area,"Float", [0x11c])
...
this.game.screenController.activeScreen.currentScreenWidth := New GameObjectStructure(this.game.screenController.activeScreen,"Int", [0x24c])
this.game.screenController.activeScreen.currentScreenHeight := New GameObjectStructure(this.game.screenController.activeScreen,"Int", [0x250])
...
this.game.gameInstances.Controller.userData.redRubies := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x13c])
this.game.gameInstances.Controller.userData.redRubiesSpent := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x140])
...
this.game.gameInstances.ActiveCampaignData.currentArea.QuestRemaining := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentArea,"Int", [0x34])
this.game.gameInstances.ActiveCampaignData.currentArea.level := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentArea,"Int", [0x2c])
...
this.game.gameInstances.FormationSaveHandler.formationSavesV2.Specializations := New GameObjectStructure(this.game.gameInstances.FormationSaveHandler.formationSavesV2,"Dict", [0x14])
...
this.game.gameInstances.Screen.uiController := New GameObjectStructure(this.game.gameInstances.Screen,"Int", [0x280])
...
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar,"Int", [0x24c])
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox,"Int", [0x268])
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButton := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar,"Int", [0x250])
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButton.toggled := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButton,"Char", [0x28e])
...
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar,"Int", [0x25c])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel,"List", [0x27c])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.nextUpgrade := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes,"Int", [0x2a0])
...
this.game.gameInstances.Screen.uiController.ultimatesBar.ultimateItems := New GameObjectStructure(this.game.gameInstances.Screen.uiController.ultimatesBar,"List", [0x270])
this.game.gameInstances.Screen.uiController.ultimatesBar.ultimateItems.hero := New GameObjectStructure(this.game.gameInstances.Screen.uiController.ultimatesBar.ultimateItems,"Int", [0x268])
