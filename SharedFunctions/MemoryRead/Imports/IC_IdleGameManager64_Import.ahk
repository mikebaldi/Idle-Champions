...
this.game.gameInstances.timeScales := New GameObjectStructure(this.game.gameInstances,"List", [0xd0])
...
this.game.gameInstances.Controller.userData := New GameObjectStructure(this.game.gameInstances.Controller,"Int", [0xb0])
this.game.gameInstances.Controller.userData.ActiveUserGameInstance := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x27c])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.def.SeatID := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.def,"Int", [0x1c8])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Int", [0x90])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByKeyName.List.parentEffectKeyHandler.activeEffectHandlers := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByKeyName.List.parentEffectKeyHandler,"List", [0x130])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.allUpgradesOrdered := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Dict", [0x2c0])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.health := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Double", [0x358])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.slotId := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Int", [0x30c])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.Owned := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Char", [0x308])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.Benched := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Char", [0x318])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.level := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Int", [0x334])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.purchasedUpgradeIDs := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"HashSet", [0x2c8])
this.game.gameInstances.ClickLevel := New GameObjectStructure(this.game.gameInstances,"Int", [0x100])
this.game.gameStarted := New GameObjectStructure(this.game,"Char", [0x100])
this.game.gameInstances.ResetsSinceLastManual := New GameObjectStructure(this.game.gameInstances,"Int", [0xec])
this.game.gameInstances.instanceLoadTimeSinceLastSave := New GameObjectStructure(this.game.gameInstances,"Int", [0xf4])
this.game.gameInstances.Controller.area := New GameObjectStructure(this.game.gameInstances.Controller,"Int", [0x18])
this.game.gameInstances.Controller.area.Active := New GameObjectStructure(this.game.gameInstances.Controller.area,"Char", [0x1e8])
...
this.game.gameInstances.Controller.userData.inited := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Char", [0x268])
this.game.gameInstances.Controller.userData.redRubies := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x248])
this.game.gameInstances.Controller.userData.redRubiesSpent := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x24c])
...
this.game.gameInstances.Controller.userData.StatHandler.BlackViperTotalGems := New GameObjectStructure(this.game.gameInstances.Controller.userData.StatHandler,"Int", [0x2a0])
this.game.gameInstances.Controller.userData.StatHandler.BrivSteelbonesStacks := New GameObjectStructure(this.game.gameInstances.Controller.userData.StatHandler,"Int", [0x300])
this.game.gameInstances.Controller.userData.StatHandler.BrivSprintStacks := New GameObjectStructure(this.game.gameInstances.Controller.userData.StatHandler,"Int", [0x304])
...
this.game.gameInstances.Controller.formation.slots := New GameObjectStructure(this.game.gameInstances.Controller.formation,"List", [0x20])
...
this.game.gameInstances.Controller.formation.TransitionOverrides := New GameObjectStructure(this.game.gameInstances.Controller.formation,"Dict", [0xb0])
...
this.game.gameInstances.OfflineHandler.OfflineTimeRequested_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0x90])
this.game.gameInstances.OfflineHandler.OfflineTimeSimulated_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0x94])
this.game.gameInstances.OfflineHandler.CurrentStopReason_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0xa0])
this.game.gameInstances.OfflineHandler.CurrentState_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0x88])
this.game.gameInstances.Screen := New GameObjectStructure(this.game.gameInstances,"Int", [0x10])
this.game.gameInstances.Screen.uiController := New GameObjectStructure(this.game.gameInstances.Screen,"Int", [0x3b8])
...
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox,"Int", [0x390])
...
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButton.toggled := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButton,"Char", [0x3ba])
...
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar,"Int", [0x378])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel,"List", [0x3b8])
