...
this.game.gameInstances.OfflineHandler.OfflineTimeRequested_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0xc0])
this.game.gameInstances.OfflineHandler.OfflineTimeSimulated_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0xc4])
this.game.gameInstances.OfflineHandler.CurrentStopReason_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0xd0])
this.game.gameInstances.OfflineHandler.CurrentState_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0xb4])
