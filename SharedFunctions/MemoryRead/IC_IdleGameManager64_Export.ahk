...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.<Level>k__BackingField := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Int", [0x318])
...
this.game.gameInstances.Controller.areaTransitioner.<IsTransitioning>k__BackingField := New GameObjectStructure(this.game.gameInstances.Controller.areaTransitioner,"Char", [0x38])
...
this.game.gameInstances.PatronHandler.<ActivePatron>k__BackingField := New GameObjectStructure(this.game.gameInstances.PatronHandler,"Int", [0x20])
this.game.gameInstances.PatronHandler.<ActivePatron>k__BackingField.ID := New GameObjectStructure(this.game.gameInstances.PatronHandler.<ActivePatron>k__BackingField,"Int", [0x10])
this.game.gameInstances.PatronHandler.<ActivePatron>k__BackingField.Tier := New GameObjectStructure(this.game.gameInstances.PatronHandler.<ActivePatron>k__BackingField,"Int", [0xc0])
